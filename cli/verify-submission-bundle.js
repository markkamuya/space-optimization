...
import { buildVerifiedIncumbentIndex, loadPublishedIncumbentIndex, queryVerifiedIncumbentIndex } from '../src/atlas/published.js';
...
const index = bundle.incumbentSnapshot
  ? buildVerifiedIncumbentIndex(bundle.incumbentSnapshot)
  : await loadPublishedIncumbentIndex();
...
if (!verifySubmissionAttestation(bundle.attestation, bundle.results ?? [], bundle.incumbentSnapshot ?? null)) errors.push('ATTESTATION_INVALID');
