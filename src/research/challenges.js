const ISSUE_NUMBERS = Object.freeze({
  'TPA-C01': 1,
  'TPA-C02': 3,
  'TPA-C03': 2,
  'TPA-C04': 4,
...
export function buildCommunityChallenges(tasks) {
  return tasks
    ...
    .map((task, index) => {
      ...
      return {
        ...
        issueUrl: `https://github.com/markkamuya/space-optimization/issues/${ISSUE_NUMBERS[challengeId]}`,
        status: 'open'
      };
    });
}
